...
class Sala(models.Model):
    ...
    nombre_sala = models.CharField(max_length=100, null=True, blank=True, verbose_name='Nombre sala de reunion')
    capacidad_sala = models.IntegerField(null=True, default=0, blank=True, verbose_name='Capacidad')
